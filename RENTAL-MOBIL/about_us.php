...
<body class="menu">
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					...
					<a class="nav-item nav-link" href="about_us.php">
						<h5 class="active font-weight-bold">About Us</h5>
					</a>
				</div>
			</div>
		</nav>
	...
	<div class="container col-5 rounded" align="center" style="font-family: 'Patrick Hand', cursive;">
		<p class="rental font-weight-bold mt-4">RENTAL RAR</p>
		<table class="table table-bordered mt-3">
			<thead>
				<tr>
					<th class="text-center" colspan="2">Karyawan</th>
				</tr>
			</thead>
			<tbody>
				<?php while ($data = mysqli_fetch_array($query)) { ?>
					...
					<tr>
						<td colspan="2" style="background:#e5a321;"></td>
					</tr>
